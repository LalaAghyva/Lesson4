package com.sirketismi.lesson4.Adapters
...
import com.sirketismi.lesson4.databinding.ListItemProductBinding
import com.sirketismi.lesson4.model.Product

class ProductListAdapter(val context : Context, var dataList: MutableList<Product>,  var onItemClick: (Product) -> Unit) : BaseAdapter() {
    ...
    override fun getView(position: Int, contentView: View?, parent: ViewGroup?): View {
        ...
        if(contentView == null) {
            val binding: ListItemProductBinding = DataBindingComponent.inflate(
